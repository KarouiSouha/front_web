      ...
      >
        <div className="flex h-full flex-col">
          ...
          <div className="border-t p-4">
            <div className="rounded-lg bg-gradient-to-br from-sky-50 to-blue-50 dark:from-sky-950 dark:to-blue-950 p-4 border border-sky-100 dark:border-sky-900">
              <div className="flex items-start gap-2 mb-2">
                <Sparkles className="h-5 w-5 text-sky-600 dark:text-sky-400 shrink-0" />
                <div>
              ...
              <div className="mt-2 h-0.5 bg-gradient-to-r from-sky-400 to-orange-400 rounded-full opacity-50" />
            </div>
          </div>
        </div>
      </aside>
